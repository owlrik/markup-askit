...
/* harmony import */ var _modules_partners_slider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/partners-slider */ "./js/modules/partners-slider.js");
...
/* harmony import */ var _modules_init_animation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-animation */ "./js/modules/init-animation.js");
...
window.addEventListener('load', function () {
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_1__["initSliders"])();
  Object(_modules_partners_slider__WEBPACK_IMPORTED_MODULE_2__["initPartnersSlider"])();
  Object(_modules_header__WEBPACK_IMPORTED_MODULE_0__["toggleMenu"])();
  Object(_modules_header__WEBPACK_IMPORTED_MODULE_0__["toggleMenuHighlighter"])();
  Object(_modules_init_modals__WEBPACK_IMPORTED_MODULE_3__["initModals"])();
  Object(_modules_init_animation__WEBPACK_IMPORTED_MODULE_4__["initAnimation"])();
...
var disableSubmit = function disableSubmit(form) {
...
/*!******************************!*\
  !*** ./js/modules/header.js ***!
  \******************************/
/*! exports provided: toggleMenu, toggleMenuHighlighter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "toggleMenu", function() { return toggleMenu; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "toggleMenuHighlighter", function() { return toggleMenuHighlighter; });
var header = document.querySelector('.page-header');
var menuToggle = header.querySelector('.page-header__toggle');
var headerNavigation = header.querySelector('.main-nav');
var navLinks = headerNavigation.querySelectorAll('.main-nav__list--main .main-nav__link[href^="#"]');
var startSection = document.querySelector('.start-home');
...
var highlightActiveMenuLink = function highlightActiveMenuLink() {
  if (window.pageYOffset + header.clientHeight >= startSection.clientHeight) {
    header.classList.add('page-header--fixed');
    var currentLink = null;
    navLinks.forEach(function (menuLink) {
      var linkedSection = document.querySelector('section#' + menuLink.href.split('#').slice(-1).pop());

      if (linkedSection) {
        var linkedSectionOffset = linkedSection.offsetTop;
        menuLink.classList.remove('main-nav__link--active');
...
var toggleMenuHighlighter = function toggleMenuHighlighter() {
...
var trackScreenBlock = function trackScreenBlock() {
...
var modalRegisterBtns = document.querySelectorAll('[data-modal="register"]');

var initModals = function initModals() {
  if (modalLogin && modalLoginBtns.length) {
    Object(_utils_modal__WEBPACK_IMPORTED_MODULE_0__["setupModal"])(modalLogin, modalLoginBtns, false);
  }

  if (modalRegister && modalRegisterBtns.length) {
    Object(_utils_modal__WEBPACK_IMPORTED_MODULE_0__["setupModal"])(modalRegister, modalRegisterBtns, false);
  }
};
...
var partnersSlider = document.querySelector('.partners-slider .swiper-container');
...
var initSwiper = function initSwiper(slider) {
  return new swiper_core__WEBPACK_IMPORTED_MODULE_0__["default"](slider, {
    slidesPerView: 'auto',
    watchOverflow: true,
    navigation: {
...
var initPartnersSlider = function initPartnersSlider() {
  if (partnersSlider) {
    var swiperSlider;
    var partnersBreakpoint = window.matchMedia('(max-width:1023px)');
...
var initSliders = function initSliders() {
  ...
  sliders.forEach(function (slider) {
    ...
    swiper_core__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper_core__WEBPACK_IMPORTED_MODULE_0__["Navigation"]]); // eslint-disable-next-line no-unused-vars

    var swiperSlider = new swiper_core__WEBPACK_IMPORTED_MODULE_0__["default"](slider.querySelector('.slider__container'), {
      slidesPerView: 'auto',
      watchOverflow: true,
      // autoHeight: true,
      loop: isInfinite,
...
var openModal = function openModal(modal) {
  ...
  Object(_vendor__WEBPACK_IMPORTED_MODULE_0__["disableBodyScroll"])(modal, {
...
var closeModal = function closeModal(modal) {
  ...
  Object(_vendor__WEBPACK_IMPORTED_MODULE_0__["enableBodyScroll"])(modal);
};
...
var setupModal = function setupModal(modal, modalBtns, noPrevDefault) {
  if (modalBtns) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "disableBodyScroll", function() { return body_scroll_lock__WEBPACK_IMPORTED_MODULE_0__["disableBodyScroll"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "enableBodyScroll", function() { return body_scroll_lock__WEBPACK_IMPORTED_MODULE_0__["enableBodyScroll"]; });
